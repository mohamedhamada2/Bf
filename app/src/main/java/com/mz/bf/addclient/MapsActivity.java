...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, OnLocationUpdatedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (codeSharedPreferance.Get_UserData(MapsActivity.this) == null){
            base_url = "https://b.f.e.one-click.solutions/";
        }else {

            base_url = codeSharedPreferance.Get_UserData(MapsActivity.this).getRecords().getUrl();
        }
...
//                                    sb.append(addresses.get(0).getCountryName());
    ...
    private void update_location(Double latitude,Double longitude) {
        if (Utilities.isNetworkAvailable(this)){
            ...
            pd.setMessage("تحميل ...");
            pd.show();
            GetDataService getDataService = RetrofitClientInstance.getRetrofitInstance(MapsActivity.this,base_url).create(GetDataService.class);
