...
public class AllCustomerServicesAdapter extends RecyclerView.Adapter<AllCustomerServicesAdapter.VisitHolder> {
    List<Visit> visitList;
    Context context;

    public AllCustomerServicesAdapter(List<Visit> visitList, Context context) {
    ...
    @NotNull
    @Override
    public AllCustomerServicesAdapter.VisitHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.visit_item,parent,false);
        return  new AllCustomerServicesAdapter.VisitHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull AllCustomerServicesAdapter.VisitHolder holder, int position) {
    ...
    class VisitHolder extends RecyclerView.ViewHolder{
        ...
        public void setData(Visit visit) {
            if (visit.getCheckType().equals("start")){
